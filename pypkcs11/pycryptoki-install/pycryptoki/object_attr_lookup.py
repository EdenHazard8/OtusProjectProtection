...
def c_get_attribute_value(h_session, h_object, template, to_hex=True):
    ...
    :param to_hex: Whether to convert c_struct to hex, instead of binary
    ...
    return ret, c_struct_to_python(c_struct, to_hex)
