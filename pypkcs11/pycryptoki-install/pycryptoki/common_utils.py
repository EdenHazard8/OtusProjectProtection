...
from .cryptoki import CK_CHAR, freeBuffer
...
def free_buffer(buffer):
    """Releases memory obtained by other functions.

    :param buffer: Pointer to a byte array, memory for whom was allocated by
        other function
    :return: retcode
    """
    ret = freeBuffer(buffer)
